<template>
  <section id="education" class="relative transition-colors duration-300" :class="colorMode.value === 'dark'
      ? 'bg-[#0D0F12]'
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div class="text-center mb-8 animate-slide-up">
        <h2 class="text-2xl md:text-3xl font-bold mb-4" :class="colorMode.value === 'dark'
            ? 'text-white'
            : 'bg-gradient-to-r from-blue-500 via-purple-500 to-cyan-500 bg-clip-text text-transparent'
          ">
          {{ $t("education.title") }}
          <span :class="colorMode.value === 'dark' ? 'text-[#809FFF]' : 'text-blue-600'
            ">
            {{ $t("education.second") }}
          </span>
        </h2>
        <div class="w-24 h-1 mx-auto rounded-full mb-6"
          :class="colorMode.value === 'dark' ? 'bg-[#809FFF]' : 'bg-blue-600'"></div>
        <p class="max-w-3xl mx-auto leading-relaxed" :class="colorMode.value === 'dark' ? 'text-slate-400' : 'text-slate-600'
          ">
      ...
      <!-- Main Education Card -->
      <div class="rounded-xl border p-6 transition-all duration-300 animate-slide-up-delayed" :class="colorMode.value === 'dark'
        ...
        <div class="flex flex-col sm:flex-row sm:items-start gap-4 mb-6">
          <!-- Institution Icon -->
          <div class="w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0" :class="colorMode.value === 'dark' ? 'bg-[#809FFF]/20' : 'bg-blue-100'
            ">
            <i class="fas fa-graduation-cap text-lg" :class="colorMode.value === 'dark' ? 'text-[#809FFF]' : 'text-blue-600'
              "></i>
          </div>

          <!-- Institution Info -->
          <div class="flex-1 min-w-0">
            <h3 class="text-xl font-semibold mb-3" :class="colorMode.value === 'dark' ? 'text-white' : 'text-slate-900'
              ">
              {{ $t("education.certification") }}
            </h3>
            <p class="text-sm leading-relaxed" :class="colorMode.value === 'dark' ? 'text-slate-400' : 'text-slate-600'
              ">
              {{ $t("education.certificationSub") }}
            </p>
            <div class="flex flex-col sm:flex-row gap-4 text-sm mt-4">
              <div class="flex items-center space-x-2">
                <i class="fas fa-university w-4 h-4" :class="colorMode.value === 'dark'
                    ? 'text-[#809FFF]'
                    : 'text-blue-600'
                  "></i>
              ...
              <div class="flex items-center space-x-2">
                <i class="fas fa-calendar-alt w-4 h-4" :class="colorMode.value === 'dark'
                    ? 'text-[#F41A81]'
                    : 'text-blue-600'
                  "></i>
                <span class="font-medium" :class="colorMode.value === 'dark'
                    ? 'text-[#F41A81]'
                    : 'text-blue-600'
                  ">
                  {{ $t("education.period") }}
          ...
          <div class="flex-shrink-0">
            <a href="/certificate.pdf" target="_blank"
              ...
              :class="colorMode.value === 'dark'
                ...
                ">
              <i class="fas fa-download w-4 h-4 mr-2 group-hover:animate-bounce"></i>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6">
          <div class="group p-4 rounded-xl border transition-all duration-300 text-center" :class="colorMode.value === 'dark'
              ? 'bg-[#1B2432] border-[#809FFF]/20'
              : 'bg-white border-slate-200/50'
            ">
            <div class="text-2xl font-bold transition-all duration-300 group-hover:scale-110" :class="colorMode.value === 'dark' ? 'text-[#809FFF]' : 'text-blue-600'
              ">
              14
            </div>
            <div class="text-xs" :class="colorMode.value === 'dark' ? 'text-slate-400' : 'text-slate-600'
              ">
              {{ $t("education.months") }}
            </div>
          </div>
        ...
        <div class="grid lg:grid-cols-2 gap-6">
          ...
          <div class="animate-slide-up-delayed-2">
            <div class="flex items-center space-x-3 mb-4">
              <div class="w-10 h-10 rounded-lg flex items-center justify-center" :class="colorMode.value === 'dark' ? 'bg-[#809FFF]/20' : 'bg-blue-100'
                ">
                <i class="fas fa-code text-lg" :class="colorMode.value === 'dark'
                    ? 'text-[#809FFF]'
                    : 'text-blue-600'
                  "></i>
              </div>
              <h4 class="text-lg font-semibold" :class="colorMode.value === 'dark' ? 'text-white' : 'text-slate-900'
                ">
                {{ $t("education.technicalCurriculum") }}
              </h4>
            </div>
            <div class="space-y-3">
              <div v-for="(item, index) in technicalCurriculum" :key="index"
                class="group rounded-lg border p-3 transition-all duration-300" :class="colorMode.value === 'dark'
                    ? 'bg-[#1B2432] border-[#809FFF]/20'
                    : 'bg-white border-slate-200/50'
                  ">
                <div class="flex items-start space-x-3">
                  <div
                    ...
                    :class="colorMode.value === 'dark'
                      ...
                      "></div>
                  <div class="flex-1 min-w-0">
                    <h5 class="font-semibold text-sm transition-colors duration-300" :class="colorMode.value === 'dark'
                        ? 'text-white group-hover:text-[#809FFF]'
                        : 'text-slate-900 group-hover:text-blue-600'
                      ">
                      {{ item.title }}
                    </h5>
                    <p class="text-xs leading-relaxed" :class="colorMode.value === 'dark'
                        ? 'text-slate-400'
                        : 'text-slate-600'
                      ">
          ...
          <div class="animate-slide-up-delayed-3">
            <div class="flex items-center space-x-3 mb-4">
              <div class="w-10 h-10 rounded-lg flex items-center justify-center" :class="colorMode.value === 'dark' ? 'bg-[#F41A81]/20' : 'bg-blue-100'
                ">
                <i class="fas fa-trophy text-lg" :class="colorMode.value === 'dark'
                    ? 'text-[#F41A81]'
                    : 'text-blue-600'
                  "></i>
              </div>
            ...
            <div class="space-y-3">
              <div v-for="(achievement, index) in keyAchievements" :key="index"
                class="group rounded-lg border p-3 transition-all duration-300" :class="colorMode.value === 'dark'
                    ? 'bg-[#1B2432] border-[#809FFF]/20'
                    : 'bg-white border-slate-200/50'
                  ">
