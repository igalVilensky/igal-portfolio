...
Igal Vilensky is a full-stack software developer based in Leipzig, Germany. He builds SaaS products, frontend interfaces, API-connected workflows, and practical AI-assisted tools using TypeScript, Vue/Nuxt, React/Next, Node.js, Python/FastAPI, REST APIs, and modern development workflows.

He has professional experience across Flowplace, LeanERA, and ARI Motors, where he worked on SaaS features, responsive user interfaces, API integrations, scalable frontend architecture, backend systems, databases, and production-ready web platforms.

He is currently extending that software development background through the AI Agents & Automations course at WBS CODING SCHOOL, with a focus on LLM workflows, prompt engineering, AI agents, n8n, Make, Python automations, APIs, webhooks, and AI safety.
...
Igal Vilensky is a Leipzig-based full-stack software developer with 3+ years of SaaS and web project experience. He works with TypeScript, Vue/Nuxt, React/Next, Node.js, Express, Python/FastAPI, REST APIs, headless CMS tools, and deployment workflows. He is currently expanding into AI agents and automations through WBS CODING SCHOOL, with portfolio proof including Flowplace Role Compass, OpenMe, Decision Matrix AI, and ARI Motors EV Portal.

## CV-Style Bio

Full-stack software developer with professional SaaS and web application experience. Skilled in TypeScript, JavaScript, Vue.js/Nuxt.js, React/Next.js, Node.js, Express, Python/FastAPI, REST APIs, headless CMS, responsive UI development, API integration, and product-focused workflows. Experienced in building production features, improving usability and accessibility, collaborating with cross-functional teams, supporting scalable codebases, and delivering web products from concept to launch. Currently strengthening AI agents, automations, LLM workflows, n8n, Make, webhooks, prompt engineering, and AI safety through the AI Agents & Automations course at WBS CODING SCHOOL.
